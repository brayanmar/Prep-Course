...
function empiezaConNueve(n) {
 ...
 let primernu= numero.split ("");
 if (primernu[0]==="9") return true;
 return false;
...
function mayorACien(array) {
  ...
  // Tu código:
  let mayor= array.filter((e)=>e>100);
  return mayor;
}
...
function breakStatement(numero) {
  ...
  console.log (array);
   if (i===array[i])return "Se interrumpió la ejecución";
   return array;
}
